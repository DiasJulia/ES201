...
\usepackage{tabularx} % Pour des tableaux à largeur fixe
\usepackage{geometry} % Pour les marges
\geometry{margin=2.5cm}

\title{ES201 TP5 (à mettre en commun)}
\author{Martin Brun}
\date{February 2026}
...
\section*{Question 4 et 5 : Quel est le processeur exécutant toujours le plus grand nombre de cycles ?}
...
\subsection*{Tableau des nombres de cycles maximums}
...
\begin{figure}[htbp]
    \centering
    \fbox{
        \includegraphics[width=0.7\linewidth]{cycles.png} 
    }
...
% --- Question 4 ---
\section*{Question 4 : Pourquoi l'analyse de cpu0 revient à analyser le temps total ?}
...
% Q6
\section*{Question 5 : Étude du SpeedUp}
...
\section*{Question 7 : IPC maximum pour chaque configuration}
...
\begin{figure}[htbp]
    \centering
    \fbox{
        \includegraphics[width=0.7\linewidth]{ipc.png} 
    }
...
\section*{Question 8 : Discussion et interprétation}
