...
\section*{Q1 : En considérant que chaque thread s’exécute sur un processeur dans une architecture
...
\section*{Q2 : Examinez le fichier de déclaration d’un élément de type « processeur superscalaire out-
...
\section*{Q3 : Examinez le fichier d’options de la plateforme se.py, puis déterminez et présentez sous
