...
% Incluir aqui as imagens que tão em figures/figures_A15 para cada configuração de cache L1 (C1 e C2) e para cada aplicação (Blowfish, Dijkstra, etc.).
% Analisar os resultados e comparar o desempenho entre as configurações de cache L1 para o Cortex A15, destacando qual configuração oferece melhor desempenho para cada aplicação.
